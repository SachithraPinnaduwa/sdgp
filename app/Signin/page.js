        ...
        <div className="flex flex-row min-h-screen">
            ...
            <div className="flex-1 p-[5%] text-blue-950 bg-white justify-center flex flex-col">
                ...
                <form className="flex flex-col">
                    ...
                    <button  className="bg-white text-black p-2 rounded-md border-2 mt-4 w-3/4 flex mx-auto justify-center">Login with Google</button>
                    <button  className="bg-white text-black p-2 rounded-md border-2 mt-4 w-3/4 flex mx-auto justify-center">Login with Facebook</button>
                </form>
            </div>
        </div>
    );
