...
function UserDetail() {
  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center mt-[-1%] mb-20 min-h-screen">
        <div className="text-center text-amber-50 mt-[20%] md:mt-[0%]">
          <h1 className="text-3xl ml-[3%] md:ml-[10%] mb-15 text-teal-400 font-semibold">
              ...
              <div className="p-3 shadow-sm rounded-sm bg-slate-100 pb-10 border dark:bg-gray-600 rounded-xl">
                <div className="text-gray-700 text-xl mt-[2%]">
                  ...
                  <div className="flex items-center font-semibold ml-[85%] mt-6 ">
                    <button
                      type="submit"
                      className="bg-teal-400 hover:bg-teal-500  p-2 rounded-md px-[15%]"
                    >
                      Save
                    </button>
                  </div>
