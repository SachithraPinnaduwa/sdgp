           ...
           <div className={'grid grid-cols-1 lg:grid-cols-12 my-auto justify-center gap-10  pb-10'}>
               ...
               <div className={'col-span-5 grid grid-cols-2 grid-rows-2  my-auto w-fit sm:w-full'}>
                   <div className={'item flex justify-center items-center'}>
                       ...
                       <Image src={'/main/foods.jpg'} alt={'stock1'} width={150} height={150} className={'rounded-[50%] object-right border-5 border-pink'}/>
                   </div>
                   <div className={'item flex justify-center items-center'}>
                   <Image src={'/main/taxi2.jpg'} alt={'stock2'} width={250} height={250} className={'rounded-[50%]'}/>
                   </div>
                       <div className={'item flex justify-center items-center'}>
                   <Image src={'/main/taxi3.jpg'} alt={'stock3'} width={250} height={250} className={'rounded-[50%]'}/>
                       </div>
                           <div className={'item flex justify-center items-center'}>
                   <Image src={'/main/taxi.jpg'} alt={'stock4'} width={150} height={150} className={'rounded-[50%] object-center'}/>
                           </div>
