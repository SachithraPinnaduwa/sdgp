                ...
                <div className="flex flex-wrap">
                    <div className="w-full px-3  lg:w-1/2 mb-10">
                        <div className="relative lg:max-w-md">
                            ...
                            <div className="absolute bottom-0 right-0 z-10 p-8 bg-white border-4  border-rose-500 rounded shadow  lg:-mb-8 lg:-mr-11 sm:p-8 dark:text-gray-300 dark:bg-gray-800">
